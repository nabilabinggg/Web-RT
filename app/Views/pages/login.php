                ...
                <div style="display: flex; flex-direction:column; padding: 50px; width: 50%; position: absolute; right:0; justify-content:space-between;">
                    ...
                    <form action="/logon" method="post" style="display: flex; flex-direction:column; margin-top: 20%">
                        <div style="margin-bottom: 40px; height: 81px;">
                            ...
                            <input style="border: 3px solid #020000; border-radius: 30px; padding: 20px; font-size: large; width:90%; float:right;" name="username" placeholder="Username" type="username" required>
                        </div>
                        <div style="margin-bottom: 30px; height: 81px;">
                            <i class="fas fa-lock" style="font-size: 50px; margin-right:20px;"></i>
                            <input style="border: 3px solid #020000; border-radius: 30px; padding: 20px; font-size: large; width:90%; float:right;" name="password" placeholder="password" type="password" required>
                        </div>
                        <a style="margin:0 0 30px auto; font-size:20px;">Forgot Password?</a>
                        <button style="height: 64px; width:auto; background: #84D9BB; border: 3px solid #000000; border-radius: 20px;" type="submit">Login</button>
