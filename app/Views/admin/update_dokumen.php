...
<body>
    <form action="/update_data_warga" method="post">
        <table style="text-align: left; justify-content: center;">
            ...
            <tr>
                ...
                <td> : <input type="input" name="jenis_pekerjaan" value="<?= $warga[0]['jenis_pekerjaan'] ?>" required>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td> : <input type="text" name="kewarganegaraan" value="<?= $warga[0]['kewarganegaraan'] ?>" required>
                </td>
            </tr>
            <tr>
                <th>
