...
<head>
    <meta charset="UTF-8">
    <title>Welcome to CodeIgniter 5!</title>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        @media (max-width: 629px) {
            >>>>>>>ba1c2f0a2e5e98bb0a4c7c764a80842c8ad713ed header ul {
                padding: 0;
            }
            ...
            header li a {
                ...
                header .menu-toggle {
                    >>>>>>>ba1c2f0a2e5e98bb0a4c7c764a80842c8ad713ed display: block;
                }
                ...
                >>>>>>>ba1c2f0a2e5e98bb0a4c7c764a80842c8ad713ed header li.menu-item a {
                    background-color: rgba(221, 72, 20, .1);
                }

                header li.menu-item a:hover,
                header li.menu-item a:focus {
                    <<<<<<< HEAD background-color: rgba(221, 72, 20, .2);
                    color: rgba(221, 72, 20, 1);
                }
        ...
        >>>>>>>ba1c2f0a2e5e98bb0a4c7c764a80842c8ad713ed
    </style>
</head>
...
<body>
    ...
    <header>
            ...
            <ul>
                <li class="logo">
                    <a href="https://codeigniter.com" target="_blank">
                        <<<<<<< HEAD <svg role="img" aria-label="Visit CodeIgniter.com official website!" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2100 500" height="44">
                ...
                <<<<<<< HEAD <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs</a>
                    </li>
        ...
        <div class="heroe">
            ...
            <<<<<<< HEAD <h1>Welcome to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

                <h2>The small framework with powerful features</h2>
                =======
                <<<<<<<<< Temporary merge branch 1 <h1>Welcome to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?>
                    </h1>
                    =========
        ...
        <section>
            ...
            <h2>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
                    <<<<<<< HEAD <rect x='32' y='96' width='64' height='368' rx='16' ry='16' style='fill:none;stroke:#000;stroke-linejoin:round;stroke-width:32px' />
            ...
            <p>The User Guide contains an introduction, tutorial, a number of "how to"
                ...
                <<<<<<< HEAD the framework. Check the <a href="https://codeigniter4.github.io/userguide" target="_blank">User Guide</a> !
            </p>
            ...
            <h2>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
                    ...
                    <p>CodeIgniter is a community-developed open source project, with several
                        ...
                        <<<<<<< HEAD the threads on <a href="https://forum.codeigniter.com/" target="_blank">CodeIgniter's forum</a>, or <a href="https://join.slack.com/t/codeigniterchat/shared_invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q" target="_blank">chat on Slack</a> !
                    </p>
